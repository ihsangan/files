    ...
    var action = {
        ...
        welcome: function () {
            if(document.referrer !== "" && document.referrer.indexOf(current.root) === -1){
                ...
                prop.content.referer && prop.content.referer.replace ? modules.render(prop.content.referer.replace(/%t/, "“" + referrer.hostname + "”")) : modules.render("欢迎来自 “" + referrer.hostname + "” 的朋友！");
            }
            else if(prop.tips){
        ...
        touch: function () {
                ...
                prop.content.touch && modules.render(prop.content.touch);
            };
        },
        // 右侧按钮
        buttons: function () {
